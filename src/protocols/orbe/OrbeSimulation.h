    ...
    namespace Protocols
    {
        namespace Orbe
        {
            ...
            public:
                ...
                {
                    m_logger.Log("OrbeSimulation::HandleGetCompleteItemFound: %d, %llu, %d\n",
                                 getReply.Value(),
                                 getReply.Timestamp(),
                ...
                {
                    //m_logger.Log("OrbeSimulation::HandleGetCompleteItemNotFound\n");
                }
                
                void HandlePutComplete(const TClientPutReplyValueType& putReply)
                {
                    m_logger.Log("OrbeSimulation::HandlePutComplete: %llu, %d\n",
                                 putReply.Timestamp(),
                                 putReply.SourceReplicaId());
                }
                
            private:
                OrbeSimulation(size_t replicasCount,
                               size_t partitionsCount,
                               size_t clientsPerPartitionCount,
                               double putToGetRatio,
                               TSchedule& schedule,
