//
//  OrbeDelayedInstallNeighbourPartitionDependencyCheckOperationState.h
//  SimRunner
//
    ...
    namespace Protocols
    {
        namespace OrbeDelayedInstall
        {
            namespace SimulatedComponents
            {
                ...
                class OrbeDelayedInstallNeighbourPartitionDependencyCheckOperationState : private boost::noncopyable
                {
                    ...
                    typedef OrbeDelayedInstallNeighbourPartitionDependencyCheckOperationState<TProtocolTraits, TCompletionHandler> TSelf;
                    ...
                    void Next()
                    {
                        ...
                        switch(currentPhase)
                        {
                            ...
                            case 1:
                            {
                                ...
                                m_neighbourPartitionServer.ReceiveNeighbourTimestampDependencyCheckRequest(m_requesterPartitionId,
                ...
                private:
                    OrbeDelayedInstallNeighbourPartitionDependencyCheckOperationState(TPartitionServer& neighbourPartitionServer,
                                                                                      TNetworkLink& link,
                                                                                      PartitionIdType requesterPartitionId,
                                                                                      ReplicaIdType sourceReplicaId,
                                                                                      TContext& context,
