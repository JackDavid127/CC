//
//  OrbeDelayedInstallNeighbourPartitionGlobalDependencyResponseOperationState.h
//  SimRunner
//
    ...
    namespace Protocols
    {
        namespace OrbeDelayedInstall
        {
            namespace SimulatedComponents
            {
                ...
                class OrbeDelayedInstallNeighbourPartitionGlobalDependencyResponseOperationState : private boost::noncopyable
                {
                    ...
                    typedef OrbeDelayedInstallNeighbourPartitionGlobalDependencyResponseOperationState<TProtocolTraits, TCompletionHandler> TSelf;
                    ...
                    void Next()
                    {
                        ...
                        switch(currentPhase)
                        {
                            ...
                            case 1:
                            {
                                ...
                                m_neighbourPartitionServer.ReceiveNeighbourGlobalTimestampDependencyCheckResponse(m_sourceReplicaId);
                                delete this;
                            }break;
                ...
                private:
                    OrbeDelayedInstallNeighbourPartitionGlobalDependencyResponseOperationState(TPartitionServer& neighbourPartitionServer,
                                                                                               TNetworkLink& link,
                                                                                               ReplicaIdType sourceReplicaId,
                                                                                               TContext& context,
                                                                                               TLogger& logger)
