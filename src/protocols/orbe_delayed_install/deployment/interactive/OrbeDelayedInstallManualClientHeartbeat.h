//
//  OrbeDelayedInstallManualClientHeartbeat.h
//  SimRunner
//
        ...
        namespace OrbeDelayedInstall
        {
            namespace Deployment
            {
                namespace Wire
                {
                    ...
                    class OrbeDelayedInstallManualClientHeartbeat
                    {
                        typedef OrbeDelayedInstallManualClientHeartbeat TSelf;
                    ...
                    private:
                        OrbeDelayedInstallManualClientHeartbeat()
                        : m_messageType(Wire::ManualClientHeartbeatMsg)
                        {
