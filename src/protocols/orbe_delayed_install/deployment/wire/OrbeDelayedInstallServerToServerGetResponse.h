//
//  OrbeDelayedInstallServerToServerGetResponse.h
//  SimRunner
//
        ...
        namespace OrbeDelayedInstall
        {
            namespace Deployment
            {
                namespace Wire
                {
                    ...
                    class OrbeDelayedInstallServerToServerGetResponse
                    {
                        typedef OrbeDelayedInstallServerToServerGetResponse TSelf;
                    ...
                    private:
                        OrbeDelayedInstallServerToServerGetResponse(Utilities::Byte foundValue,
                                                      TKeyType key,
                                                      TClientInputValueType value,
                                                      TTimestamp timestamp,
                                                      ClientIdType clientId,
