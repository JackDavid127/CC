//
//  OrbeDelayedInstallPartitionConnectionFactory.h
//  SimRunner
//
            ...
            namespace Deployment
            {
                namespace Server
                {
                    namespace Neighbours
                    {
                        ...
                        class OrbeDelayedInstallPartitionConnectionFactory
                        {
                        ...
                        public:
                            ...
                            OrbeDelayedInstallPartitionConnectionFactory(TPartitionServer& partitionServer,
