//
//  OrbeDelayedInstallReplicaConnectionFactory.h
//  SimRunner
//
            ...
            namespace Deployment
            {
                namespace Server
                {
                    namespace Replica
                    {
                        ...
                        class OrbeDelayedInstallReplicaConnectionFactory
                        {
                        ...
                        public:
                            ...
                            OrbeDelayedInstallReplicaConnectionFactory(TPartitionServer& partitionServer,
