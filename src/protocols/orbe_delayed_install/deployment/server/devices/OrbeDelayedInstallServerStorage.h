//
//  OrbeDelayedInstallServerStorage.h
//  SimRunner
//
            ...
            namespace Deployment
            {
                namespace Server
                {
                    namespace Devices
                    {
                        ...
                        class OrbeDelayedInstallServerStorage : private boost::noncopyable
                        {
                        public:
                            
                            OrbeDelayedInstallServerStorage(Components::KeyValueStorage<TKey, TSerializedValueType>& storage)
                            : m_store(storage)
                            {
