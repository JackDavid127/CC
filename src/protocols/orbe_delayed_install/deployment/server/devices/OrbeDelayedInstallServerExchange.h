            ...
            namespace Deployment
            {
                namespace Server
                {
                    namespace Devices
                    {
                        ...
                        class OrbeDelayedInstallServerExchange : private boost::noncopyable
                        {
                        ...
                        public:
                            ...
                            OrbeDelayedInstallServerExchange(PartitionIdType partitionId,
                                                                     ...
                                                                     const TVersionVector& versionVector)
                            {
                                ...
                                connection.SendHeartbeatVectorMessageToReplica(senderReplicaId,
                                                                               mutualPartitionId,
                                                                               versionVector);
                            }
                                                            ...
                                                            const PartitionIdType& requestDestinationPartitionId)
                            {
                                SR_ASSERT(m_partitionConnections[requestDestinationPartitionId] != nullptr);
                                TPartitionConnection& connection = *(m_partitionConnections[requestDestinationPartitionId]);
                                connection.PerformPutForNeighbour(client,
                                                                  key,
                                                                  value,
                                                                                                               ...
                                                                                                               ReplicaIdType sourceReplicaId)
                            {
                                SR_ASSERT(m_partitionConnections[requestDestinationPartitionId] != nullptr);
                                TPartitionConnection& connection = *(m_partitionConnections[requestDestinationPartitionId]);
                                connection.RequestIsNeighbourTimestampGreaterThanOrEqualToReplicationDependencyTimestamp(localPartitionId,
                                                                                                                         sourceReplicaId,
                                                                                                                         clientDependencyTimestamp);
                            }
                                                                                ...
                                                                                ReplicaIdType sourceReplicaId)
                            {
                                SR_ASSERT(m_partitionConnections[requestDestinationPartitionId] != nullptr);
                                TPartitionConnection& connection = *(m_partitionConnections[requestDestinationPartitionId]);
                                connection.SendUnblockingDependencyTimestampCheckResponse(sourceReplicaId);
                            }
                                                                                                       ...
                                                                                                       ReplicaIdType sourceReplicaId)
                            {
                                SR_ASSERT(m_partitionConnections[requestDestinationPartitionId] != nullptr);
                                TPartitionConnection& connection = *(m_partitionConnections[requestDestinationPartitionId]);
                                connection.RequestIsNeighbourGlobalTimestampNotLessThanDependencyGlobalTimestamp(localPartitionId,
                                                                                                                 sourceReplicaId,
                                                                                                                 clientDependencyTimestamp);
                                                                                      ...
                                                                                      ReplicaIdType sourceReplicaId)
                            {
                                SR_ASSERT(m_partitionConnections[requestDestinationPartitionId] != nullptr);
                                TPartitionConnection& connection = *(m_partitionConnections[requestDestinationPartitionId]);
                                connection.SendUnblockingGlobalDependencyTimestampCheckResponse(sourceReplicaId);
                            }
